                            ...
                            <div class="row mt-1">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input readonly type="text" class="form-control" name="firstName" value="<?= $teachers[0]->first_name ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input readonly type="text" class="form-control" name="middleName" value="<?= $teachers[0]->middle_name ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Last Name:</label>
                                        <div class="col-sm-9">
                                            <input readonly type="text" class="form-control" name="lastName" value="<?= $teachers[0]->last_name ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input readonly type="text" class="form-control" name="advisory" value="<?= $teachers[0]->advisory ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea readonly class="form-control" rows="20" name="address"><?= $teachers[0]->address ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input readonly type="text" class="form-control" name="phone" value="<?= $teachers[0]->phone ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Email:</label>
                                        <div class="col-sm-9">
                                            <input readonly type="text" class="form-control" name="email" value="<?= $teachers[0]->email ?>">
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <?php if($teachers[0]->subject_id == $each->id) { $subject = $each->subject_name; break; }?>
                                            <?php endforeach;?>
