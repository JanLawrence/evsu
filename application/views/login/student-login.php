                    ...
                    <div class="login-content" style="margin: 40px;">
                        ...
                        <div class="login-form">
                            ...
                            <form method="post" action="student">
                                ...
                                <button type="submit" class="btn btn-info btn-flat m-b-30 m-t-30" style=" background: linear-gradient(120deg, #00d2ff, #3a7bd5);">Sign in</button>
    ...
    <script>
        $(function(){
            ...
            $('.btn-proceed').click(function(){
                ...
                if(email != ''){
                    $.post(URL+'account/emailSendingStudent', {'email': email})
                    .done(function(returnData){
                        if(returnData == 1){
                            location.href = URL + 'account/changePassStudent?email=' + email;
                        } else {
                            alert('Invalid email')
                        }
                    }) 
